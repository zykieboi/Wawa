...
if (!self.__WB_pmw) {
  ...
  ; // bundle: page___f696161066a5ac699d299e06562c356d_m
  ...
  typeof Roblox == "undefined" && (Roblox = {}), typeof Roblox.Resources == "undefined" && (Roblox.Resources = {}), typeof Roblox.Resources.AnimatedSignupFormValidator == "undefined" && (Roblox.Resources.AnimatedSignupFormValidator = {
      ...
      tooLong: "Must be less than 21 characters long",
      ...
      function a(n, t) {
          $.get("/api/v1/users/checkifinvalidusernameforsignup", {
              username: n
          }).done(function(n) {
              var i = s[n.data] || "";
              t(n.data === 0, i, n.data)
      ...
      function y(f) {
          return t(f) ? Roblox.Resources.AnimatedSignupFormValidator.tooShort : n(f) ? Roblox.Resources.AnimatedSignupFormValidator.tooLong : i(f) ? Roblox.Resources.AnimatedSignupFormValidator.startsOrEndsWithUnderscore : r(f) ? Roblox.Resources.AnimatedSignupFormValidator.moreThanOneUnderscore : u(f) ? Roblox.Resources.AnimatedSignupFormValidator.invalidName : ""
      }

      function p(n, t) {
          return f(n) ? Roblox.Resources.AnimatedSignupFormValidator.tooShort : e(n, t) ? Roblox.Resources.AnimatedSignupFormValidator.passwordIsUsername : o(n) ? Roblox.Resources.AnimatedSignupFormValidator.weakKey : ""
      }
      var s = {
          1: Roblox.Resources.AnimatedSignupFormValidator.alreadyTaken,
          2: Roblox.Resources.AnimatedSignupFormValidator.cantBeUsed
      };
      return {
          invalidBirthday: h,
          selectedBirthday: c,
          ...
          usernameTooLong: n,
          usernameTooShort: t,
          usernameRegexInvalid: u,
          usernameStartsOrEndsWithUnderscore: i,
          usernameHasMoreThanOneUnderscore: r,
          getInvalidUsernameMessage: y,
          checkIfUsernameInvalid: a,
  ...
  function MoveMagicLine(n) {
      ...
      if (t.length != 0 && (!t.is(":animated") || n)) {
          ...
          if (u < $("#WhatsRobloxContainer").offset().top - $(".navbar-landing").height()) {
              ...
              t.data("curtab", 2), Roblox.EventStream && (Roblox.AboutLink.aboutLinkSeenTimes++, Roblox.EventStream.SendEvent("navigatedToAboutLink", "aboutLinkSeen" + Roblox.AboutLink.aboutLinkSeenTimes + "times", {}))
          } else {
  ...
  Roblox.AboutLink = {}, Roblox.AboutLink.aboutLinkSeenTimes = 0, $(function() {
      ...
      Roblox.SignupOrLogin.init({
          onSignupSuccess: function() {
              ...
              typeof n == "string" && n.length > 0 ? (n += n.indexOf("?") === -1 ? "?" : "&", n += "nu=true", window.location.href = n) : window.location.href = "/home?nu=true"
          },
  ...
  "use strict";
  var signupOrLogin = angular.module("SignupOrLogin", ["roblox.formEvents", "robloxApp.helpers"]);
  ...
  signupOrLogin.directive("rbxValidPassword", function() {
      return {
          ...
          link: function(n, t, i, r) {
              n.$watch(function() {
                  return !angular.isUndefined(r.$modelValue) && Roblox.SignupFormValidatorGeneric.getInvalidPasswordMessage(r.$modelValue, n.signup.username)
              }, function(t) {
      ...
      return {
          ...
          link: function(t, i, r, u) {
              t.signup.username = i.val(), t.usernameValidationRequestNum = 0, t.onChange = function() {
                  ...
                  f == 1 && t.signupForm.username && t.signup.username && (t.signupForm.username.$dirty = !0), e ? (r = !0, i = "Please enter a username.") : (i = Roblox.SignupFormValidatorGeneric.getInvalidUsernameMessage(t.signup.username), i !== "" && (r = !0)), u.$setValidity("validusername", !r), r ? u.$validationMessage = i : (u.$validationMessage = "", n({
                      method: "GET",
                      url: "/api/v1/users/checkifinvalidusernameforsignup",
                      params: {
      ...
      var i = Roblox.SignupOrLogin.CaptchaFlowType.signup,
          u = function(n, u, f) {
              var s = angular.element(n.target),
                  ...
                  h = {
                      recaptcha_challenge_field: e.find("#recaptcha_challenge_field").val(),
                      recaptcha_response_field: e.find("#recaptcha_response_field").val(),
                      "g-Recaptcha-Response": e.find("#g-recaptcha-response").val()
                  },
                  o;
              if (f.captchaFlowType === Roblox.SignupOrLogin.CaptchaFlowType.signup) o = s.data("signup-captcha-api-url");
              else if (i === Roblox.SignupOrLogin.CaptchaFlowType.login) o = s.data("log-in-captcha-api-url"), h.username = f.username;
              else throw "Unknown Captcha flow";
              return f.isSubmitting = !0, t({
                  method: "POST",
                  url: o,
                  data: $.param(h),
                  headers: {
